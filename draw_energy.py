...
power = [5.83, 3.50, 1.45, 6.88, 6.02, 7.41]
...
bar_width = 0.25
for i, br in enumerate(zip(devices, power, r34, r50, rgx16, rgx4)):
    br = list(br)
    print(xbr)
    plt.bar(xbr, [br[1] * x for x in br[2:]], color=colors[i], width=bar_width, label=br[0])
    xbr = xbr + bar_width
